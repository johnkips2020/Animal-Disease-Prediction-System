...
def home():
    ...
    return render_template("AnimalDiseasePrediction.html", AnimalName=AnimalName, symptoms1=symptoms1,
                           symptoms2=symptoms2, symptoms3=symptoms3, symptoms4=symptoms4, symptoms5=symptoms5)
...
def predict():
    if request.method == "POST":
        ...
        return render_template('AnimalDiseasePrediction.html',
